...
import br.sigo.aplicacao.config.audit.AuditEventConverter;
import br.sigo.aplicacao.domain.PersistentAuditEvent;
...
import static br.sigo.aplicacao.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
